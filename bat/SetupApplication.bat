...
:: Android packaging
set AND_CERT_NAME="OniEngine"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\OniEngine.p12
...
set IOS_PROVISION=cert\OniEngine.mobileprovision
...
set APP_ID=com.oniengine

:: Output packages
set DIST_PATH=dist
set DIST_NAME=OniEngine
