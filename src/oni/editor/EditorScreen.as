package oni.editor 
{
	...
	public class EditorScreen extends GameScreen
	{
		...
		public function EditorScreen(oni:Oni) 
		{
			...
			//Load a level!
			scene = new Scene(false, 0xFFFFFF);
		...
		private function _onStageTouch(e:TouchEvent):void
		{
			...
			if (!_windowsVisible)
			{
				...
				if (touches.length == 1)
				{
					...
					else if (_pickIcon.selected && _vectorEditor.parent == null)
					{
			...
			switch(e.keyCode)
			{
				...
				case 86: //V
							 ...
							 _selectedEntities[0] is SmartTexture)
					{
						...
						_vectorEditor.x = _selectedEntities[0].x;
						_vectorEditor.y = _selectedEntities[0].y;
						addChild(_vectorEditor);
					}
					break;
