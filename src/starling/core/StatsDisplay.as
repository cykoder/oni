...
package starling.core
{
    ...
    internal class StatsDisplay extends Sprite
    {
        ...
        {
            mBackground = new Quad(150, 100, 0x0);
            mTextField = new TextField(mBackground.width-2, mBackground.height, "", BitmapFont.MINI, mBackground.height/4, 0xffffff);
            mTextField.x = 5;
        ...
        {
            mTextField.text = "OniEngine" +
							"\nFPS: " + fps.toFixed(fps < 100 ? 1 : 0) + 
