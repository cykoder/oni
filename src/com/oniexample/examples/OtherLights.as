package com.oniexample.examples 
{
	...
	public class OtherLights extends GameScreen
	{
		...
		public function OtherLights(oni:Oni) 
		{
			...
			_ambientLight = new AmbientLight({colour: 0xFFFFFF, intensity: 0.1});
			entities.add(_ambientLight);
			
			//Create a polygon light
			_polygonLight = new PolygonLight({colour: 0xFF0000, intensity: 1, lightPoints: [new Point(0, 100),
														   new Point(100,0),
														   new Point(200,100),
														   new Point(150,200),
														   new Point(50, 200),
			...
			light = new TexturedLight({texture: "light_oniworks", colour: 0xFFFFFF, intensity: 1});
			light.x = 780;
			light.y = 350;
			entities.add(light);
